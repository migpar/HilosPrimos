...
public class HiloThreads extends Thread{
	
	private String valorImprimir;
	
	public HiloThreads(String valorImprimir) {
	...
	public void run() {
		...
		for (int i = 0; i < 20; i++) {
			try {
				//este metodo duerme el hilo que este pasando en esta linea dirante un triempo en milisegundos
			...
			System.out.println("Hilo: " + Thread.currentThread().getName() + ", dice: " + valorImprimir + " ciclo: " + i + "\n");
		}
